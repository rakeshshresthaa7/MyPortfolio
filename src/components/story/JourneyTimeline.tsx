        ...
        <div className="relative">
          ...
          {journeySteps.map((step, idx) => (
            <motion.div
              ...
              className={`mb-10 flex flex-col md:flex-row items-center gap-6 ${idx % 2 === 0 ? "md:flex-row-reverse" : ""}`}
            >
              ...
              <motion.div whileHover={{ scale: 1.3 }} className="w-5 h-5 bg-black border-4 border-black rounded-full shadow-[3px_3px_0_0_rgba(255,0,107,1)] flex-shrink-0 z-10 hidden md:block" />
